...
local run_prompt = require("widgets.run-popup.run-popup")
modkey = "Mod4"
...
globalkeys = gears.table.join(
	...
	-- Prompt
	awful.key({ modkey }, "r", function () run_prompt:show()
    end,
	...
	--Brightness 
	awful.key({ }, "XF86MonBrightnessUp",   function () awful.spawn("brightnessctl set +5%", false) end, {description = "increase brightness", group = "custom"}),
	awful.key({ }, "XF86MonBrightnessDown", function () awful.spawn("brightnessctl set 5%-", false) end, {description = "decrease brightness", group = "custom"}),
